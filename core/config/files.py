...
class CacheFile:
    ...
    def save_models(self, models: List["ModelConfig"]) -> None:
        try:
            ...
            raise CacheFileError(f"Permission denied writing to cache file: {self.cache_file}") from e
        except OSError as e:
        ...
        try:
            ...
            with open(self.cache_file, "r", encoding="utf-8") as f:
                try:
                    ...
                    raise CacheFileError(f"Invalid JSON in cache file {self.cache_file}", cause=e) from e
                finally:
...
class EnvFile:
    ...
    def _read_env_file(self) -> Dict[str, str]:
        ...
        try:
            ...
            raise EnvFileError(f"Permission denied reading env file: {self.env_file}") from e
        except OSError as e:
    ...
    def _write_env_file(self, env_vars: Dict[str, str]) -> None:
        try:
            ...
            raise EnvFileError(f"Permission denied writing to env file: {self.env_file}") from e
        except OSError as e:
